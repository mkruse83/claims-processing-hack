...
if __name__ == "__main__":
    ...
    print("Testing Mistral Document AI OCR...")
    
    # Configure logging
    logging.basicConfig(level=logging.INFO)
    
    # Test with a sample file (adjust path as needed)
    test_file = "/tmp/crash1_front.jpeg"
    
    if os.path.exists(test_file):
        try:
            result = get_ocr_results(test_file)
        ...
        print("Please provide a valid image file path to test.")
